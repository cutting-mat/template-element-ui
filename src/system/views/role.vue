  ...
  <div class="flex-col" v-loading="loading">
    <div class="flex-1 scrollbar">
      <div class="flex-row align-center pageHeader">
        ...
        <el-button v-has="role.add" type="primary" size="small" icon="el-icon-plus" @click="dialogVisible=true">添加</el-button>
      </div>
    ...
    <el-dialog
      ...
      <el-form size="small" ref="editForm" :rules="rules" :model="editForm" label-width="80px">
        ...
        <el-form-item label="权限">
          <resourcePicker 
            picker
            :checked="editForm.menuIdList"
            @checked="editForm.menuIdList = $event"
          />
        </el-form-item>
